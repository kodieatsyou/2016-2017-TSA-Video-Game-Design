Shader "Nature/Terrain/Triplanar"
{
	Properties
	{
	...
	SubShader 
	{
		...
		#pragma surface surf Standard vertex:SplatmapVert finalcolor:final exclude_path:prepass exclude_path:deferred fullforwardshadows
	...
	Dependency "AddPassShader" = "Hidden/TerrainEngine/Splatmap/TerrainTriplanar-AddPass"
