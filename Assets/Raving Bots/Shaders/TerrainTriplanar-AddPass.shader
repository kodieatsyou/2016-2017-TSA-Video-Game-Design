Shader "Hidden/TerrainEngine/Splatmap/TerrainTriplanar-AddPass" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		#pragma surface surf Standard decal:add vertex:SplatmapVert finalcolor:final exclude_path:prepass exclude_path:deferred fullforwardshadows
